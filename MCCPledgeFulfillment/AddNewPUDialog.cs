...
namespace MCCPledgeFulfillment
{
    public partial class AddNewPUDialog : Form
    {
        ...
        public AddNewPUDialog(Transactions trans)
        {
            donationSheets = trans.Application.Sheets;

            InitializeComponent();

            Excel.Range r = ((Excel.Worksheet)trans.Application.Sheets["Types"]).get_Range("A1:B1");
            string s;
